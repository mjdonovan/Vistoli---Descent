...
\usepackage{amssymb, enumerate, xspace, graphicx, url,version,framed,color}
\usepackage[all]{xy}
\SelectTips{cm}{}

%I added `framed' and `color', and the following line
...
%%%%%%%%
\excludeversion{3   FIBERED CATEGORIES}
